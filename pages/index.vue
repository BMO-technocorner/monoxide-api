...
// @ts-ignore
import Typewriter from "vue-writer";
import AOS from "aos";
...
<template>
  <div class="relative overflow-hidden">
    <div class="absolute inset-y-0 h-full w-full" aria-hidden="true">
      <div class="relative h-full dark:opacity-20 transition-opacity">
        <svg
    ...
    <div class="relative pt-6 pb-28 sm:pb-24">
      <div
      ...
      <div class="mx-auto max-w-7xl px-8 sm:px-6 mt-28 sm:mt-6">
        <div class="text-center">
          <h1
            data-aos="zoom-in"
            data-aos-duration="1000"
            data-aos-delay="200"
            class="text-4xl px-2 h-12 md:h-fit tracking-tight font-extrabold text-gray-900 dark:text-gray-100 sm:text-5xl md:text-6xl transition-color"
          >
            <span class="block">The 🧠 behind</span>
            <span
              class="block text-violet-700 dark:text-violet-400 transition-color"
            >
              <Typewriter
                :array="monoxideAcronyms"
                :start="1500"
                :delay="6000"
                caret="cursor"
                >Monoxide</Typewriter
          ...
          <p
            ...
            data-aos-duration="1000"
            data-aos-delay="400"
            class="mt-24 md:mt-6 max-w-md mx-auto text-base text-gray-500 dark:text-gray-400 sm:text-lg md:text-xl md:max-w-3xl transition-color"
          >
            Written carefully and deployed with love, Monoxide API gives life to
            the Monoxide IoT Integrated Platform.
          </p>
          <div
            data-aos="zoom-in"
            data-aos-duration="1000"
            data-aos-delay="800"
            class="mt-8 md:text-xl w-full flex align-center"
          >
            <NuxtLink
              to="https://insomnia.rest/run/?label=Monoxide&uri=https%3A%2F%2Fapi-monoxide.ezralazuardy.com%2Fv1%2FMonoxide.json"
              target="_blank"
              class="mx-auto"
            >
              <img
                class="rounded-lg h-10 shadow-lg hover:scale-105 active:scale-95 active:opacity-80 transition"
                src="~/assets/images/insomnia.svg"
                alt="Run in Insomnia"
              />
            </NuxtLink>
          </div>
    ...
    <div class="relative">
      ...
      >
        <img
          class="relative rounded-lg shadow-xl hover:scale-105 transition"
          src="~/assets/images/monoxide-insomnia.png"
          alt="Monoxide API in Insomnia"
        />
      </div>
    </div>
  </div>
  <div class="bg-violet-900 dark:bg-stone-800 transition-color pt-8 sm:pt-0">
    <div class="relative py-0 sm:py-32 mx-auto max-w-7xl px-8 text-left">
      <h1
        data-aos="fade-right"
        data-aos-duration="1000"
        data-aos-delay="200"
        class="text-4xl sm:text-5xl tracking-tight font-extrabold text-gray-900 dark:text-gray-100 transition-color"
      >
        <span class="text-gray-100">Adopting a set of</span>
        <span class="text-violet-200 dark:text-violet-400 transition-color">
          Industry Standards
        </span>
      </h1>
      <p
        ...
        data-aos-duration="1000"
        data-aos-delay="400"
        class="mt-4 md:mt-6 text-base text-gray-300 dark:text-gray-400 sm:text-lg md:text-xl md:max-w-3xl transition-color"
      >
        Monoxide API implements some of the industry standard such as
        <NuxtLink
          to="https://jwt.io"
          target="_blank"
          title="JWT"
          class="text-violet-300 active:text-violet-400 hover:underline transition"
        >
          JSON Web Tokens</NuxtLink
        >
        and
        <NuxtLink
          ...
          title="CORS Protocol"
          class="text-violet-300 active:text-violet-400 hover:underline transition"
          >CORS Protocol</NuxtLink
        >. Developed from scratch with a security-first approach.
      </p>
      <p
        data-aos="fade-right"
        data-aos-duration="1000"
        data-aos-delay="500"
        class="mt-2 md:mt-6 text-base text-gray-300 dark:text-gray-400 sm:text-lg md:text-xl md:max-w-3xl transition-color"
      >
        Standards:
        <NuxtLink
          to="https://datatracker.ietf.org/doc/html/rfc6454"
          target="_blank"
          title="RFC 6454"
          class="text-violet-300 active:text-violet-400 hover:underline transition"
        >
        ...
        ,
        <NuxtLink
          to="https://datatracker.ietf.org/doc/html/rfc7231"
          target="_blank"
          title="RFC 6454"
          class="text-violet-300 active:text-violet-400 hover:underline transition"
        >
        ...
        ,
        <NuxtLink
          to="https://datatracker.ietf.org/doc/html/rfc7234"
          target="_blank"
          title="RFC 6454"
          class="text-violet-300 active:text-violet-400 hover:underline transition"
        >
        ...
        ,
        <NuxtLink
          to="https://datatracker.ietf.org/doc/html/rfc7235"
          target="_blank"
          title="RFC 6454"
          class="text-violet-300 active:text-violet-400 hover:underline transition"
        >
    ...
    <div class="relative py-16 sm:py-32 mx-auto max-w-7xl px-8 text-left">
      <h1
        data-aos="fade-right"
        data-aos-duration="1000"
        data-aos-delay="200"
      ...
      >
        ...
        <span class="text-gray-100">❤️ Open Source</span>
      </h1>
      <p
        data-aos="fade-right"
        data-aos-duration="1000"
        ...
        class="mt-4 md:mt-6 text-base text-gray-300 dark:text-gray-400 sm:text-lg md:text-xl md:max-w-3xl transition-color"
      >
        Built with the most modern; battle tested open source technologies,
        Monoxide project aim to develop an accessible platform for everyone. For
      ...
      <div
        class="my-10 sm:my-14 w-full grid grid-cols-3 sm:grid-cols-9 gap-10 justify-center items-center text-gray-300 transition"
      >
        <NuxtLink
          to="https://nextjs.org"
          target="_blank"
        ...
        >
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            class="h-20 w-20 hover:scale-110 active:scale-95 hover:text-violet-300 transition"
        ...
        >
          ...
          >
            ...
            <path
              d="M0 22C1.03435e-06 9.84973 9.84974 -1.03435e-06 22 0C30.9336 7.80998e-07 38.6235 5.3248 42.069 12.9737L12.9737 42.069C11.7252 41.5066 10.5385 40.8311 9.42689 40.0555L27.4824 22H22L6.44366 37.5563C2.46244 33.5751 -5.31105e-07 28.0751 0 22Z"
            ></path>
            <path
              d="M44 22.0076L22.0076 44C34.1518 43.9959 43.9959 34.1518 44 22.0076Z"
            ></path>
          </svg>
        </NuxtLink>
      </div>
    ...
    <div class="relative py-2 md:py-20">
      ...
      >
        <div class="lg:grid lg:grid-cols-12">
          ...
          >
            <div
              class="max-w-md mx-auto px-8 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0"
            >
              <div class="aspect-square">
                <img
                  ...
                  data-aos-duration="1000"
                  data-aos-delay="200"
                  class="aspect-square object-cover object-center rounded-xl shadow-2xl"
                  src="~/assets/images/monoxide-light.png"
                  alt="Monoxide Logo"
                />
              </div>
            </div>
          ...
          >
            ...
            >
              <h2
                class="text-3xl font-extrabold text-gray-900 dark:text-gray-100 transition-color"
                id="join-heading"
              >
                About Monoxide
              </h2>
